...
<head>
    ...
    <title>Resident Login | Barangay e-Governance</title>
</head>
...
<div class="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
    <svg class="w-full h-full opacity-25" viewBox="0 0 800 600" preserveAspectRatio="xMidYMid slice">
        <defs>
...
<section class="min-h-screen flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md bg-white/60 dark:bg-gray-800/70 backdrop-blur-lg rounded-2xl shadow-xl p-8 space-y-6 ring-1 ring-gray-300 dark:ring-gray-600">
        ...
        <div class="flex flex-col items-center space-y-3">
            ...
            <p class="text-base text-gray-600 dark:text-gray-300 text-center font-medium">Resident's Login Portal</p>
        </div>
        ...
        <form class="space-y-4" action="#">
            ...
            <div class="flex items-center justify-between text-sm">
                <label class="flex items-center text-gray-600 dark:text-gray-400">
                    <input type="checkbox" class="mr-2 rounded border-gray-300 dark:border-gray-500">
                    Remember me
                </label>
        ...
        <div class="text-center pt-2">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="{{ route('residents.register') }}" class="font-semibold text-blue-600 hover:underline dark:text-blue-400">Sign up</a>
            </p>
        </div>
