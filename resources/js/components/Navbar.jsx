        ...
        <div className="flex items-center">
          ...
          <a href="/" className="flex items-center ml-4">
            ...
            <span className="ml-3 text-xl font-bold text-white hidden sm:block">
              E-Governace Barangay Management System
            </span>
          </a>
        </div>
          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-3 w-64 bg-white rounded-lg shadow-xl z-50 animate-fade-in-up">
              <div className="px-4 py-3 border-b border-gray-200">
                <p className="text-sm font-semibold text-gray-800">Neil Sims</p>
                <p className="text-sm text-gray-500">neil.sims@flowbite.com</p>
              </div>
